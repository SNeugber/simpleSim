...
public class Network {
  ...
  public Network clone() {
	  Network n = new Network(inputCount, hiddenCount, outputCount, learnRate, momentum);
	  n.setNetwork(matrix.clone(), fire.clone(), thresholds.clone());
	  return n;
  }
  
  private void setNetwork(double[] matrix, double[] fire, double[] thresholds) {
	  this.matrix = matrix;
	  this.fire = fire;
	  this.thresholds = thresholds;
  }
  
  public int getInputNeuronNum() {
	  return inputCount;
  }
}
